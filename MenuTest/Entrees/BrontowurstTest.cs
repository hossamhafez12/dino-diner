...
namespace MenuTest.Entrees
{
    public class BrontowurstUnitTest
    {
        ...
        [Fact]
        public void HoldOnionBunPeppersShouldAddToSpecial()
        {
            Brontowurst bw = new Brontowurst();
            bw.HoldOnion();
            bw.HoldBun();
        ...
        [Fact]
        public void HoldingOnionShouldNotifySpecialChanged()
        {
            Brontowurst bw = new Brontowurst();
        ...
        [Fact]
        public void HoldingPeppersShouldNotifySpecialChanged()
        {
            Brontowurst bw = new Brontowurst();
            Assert.PropertyChanged(bw, "Special", () =>
            {
