...
namespace MenuTest.Entrees
{
    public class SteakosaurusBurgerUnitTest
    {
        ...
        [Fact]
        public void HoldBunPicklesKetchupMustardShouldAddToSpecial()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
            sb.HoldBun();
            sb.HoldPickle();
        ...
        [Fact]
        public void HoldingBunShouldNotifySpecialChanged()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
        ...
        [Fact]
        public void HoldingPickleShouldNotifySpecialChanged()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
            Assert.PropertyChanged(sb, "Special", () =>
            {
        ...
        [Fact]
        public void HoldingKetchupShouldNotifySpecialChanged()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
            Assert.PropertyChanged(sb, "Special", () =>
            {
        ...
        [Fact]
        public void HoldingMustardShouldNotifySpecialChanged()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
            Assert.PropertyChanged(sb, "Special", () =>
            {
